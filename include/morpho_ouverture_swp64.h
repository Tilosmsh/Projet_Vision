...
//#pragma message("including morpho_ouverture_swp64.h ...")
// ======================
// == fonctions lignes ==
// ======================
...
void line_ouverture3_ui64matrix_swp64_fusion_elu2_red_factor     (uint64 **X, int i, int j0, int j1, uint64 **T);
...
void ouverture3_ui64matrix_swp64_pipeline_ilu3_elu2           (uint64 **X, int i0, int i1, int j0, int j1, uint64 **T, uint64 **Y);
