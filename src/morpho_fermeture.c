...
// -----------------------------------------------------------------------------------
void line_fermeture3_ui8matrix_fusion_red_mat(uint8 **X, int i, int j0, int j1, uint8 **Y)
// -----------------------------------------------------------------------------------
{
    uint8 x[5][5];
    uint8 z[3][3];
...
// ----------------------------------------------------------------------------------------
void line_fermeture3_ui8matrix_fusion_red(uint8 **X, int i, int j0, int j1, uint8 **Y)
// -----------------------------------------------------------------------------------
{
    ...
    for(int j = j0 ; j <= j1 ; j++ ){
        ...
        max = and9(z00,z01,z02,z10,z11,z12,z20,z21,z22);
...
// ---------------------------------------------------------------------------------------------
void line_fermeture3_ui8matrix_fusion_elu2_red(uint8 **X, int i, int j0, int j1, uint8 **Y)
// ----------------------------------------------------------------------------------------
{
    uint8 x[6][5];
    uint8 z[3][3];
    ...
    for(int j = j0 ; j <= j1 ; j++ ){
        ...
        z[0][0]=or9_mat33(x,1,0);
        z[0][1]=or9_mat33(x,1,1);
        z[0][2]=or9_mat33(x,1,2);

        z[1][0]=or9_mat33(x,2,0);
        z[1][1]=or9_mat33(x,2,1);
        z[1][2]=or9_mat33(x,2,2);

        z[2][0]=or9_mat33(x,3,0);
        z[2][1]=or9_mat33(x,3,1);
        z[2][2]=or9_mat33(x,3,2);
...
//-----------------calc factor-------------------
        ...
        factor = and6(z10,z20,z11,z21,z12,z22);
...
{
    for(int i = i0; i <= i1 ; i++ ){
        line_fermeture3_ui8matrix_fusion_basic(X, i, j0, j1, Y);
    }
}
// ---------------------------------------------------------------------------------------
void fermeture3_ui8matrix_fusion_red(uint8 **X, int i0, int i1, int j0, int j1, uint8 **Y)
// ---------------------------------------------------------------------------------------
{
    for(int i = i0; i <= i1 ; i++ ){
        line_fermeture3_ui8matrix_fusion_red(X, i, j0, j1, Y);
    }
}
// --------------------------------------------------------------------------------------------
...
// --------------------------------------------------------------------------------------------
void fermeture3_ui8matrix_fusion_elu2_red(uint8 **X, int i0, int i1, int j0, int j1, uint8 **Y)
// --------------------------------------------------------------------------------------------
{
    int i, r = (i1 - i0 + 1)%2;
    for(int i = i0; i <= i1-r ; i+=2 ){
        line_fermeture3_ui8matrix_fusion_elu2_red(X, i, j0, j1, Y);
    }
    if(r){
        line_fermeture3_ui8matrix_fusion_basic(X, i, j0, j1, Y);
    }
...
{
    //prologue pipeline
    line_dilatation3_ui8matrix_basic(X,i0-1,j0-1,j1+1,T);
    line_dilatation3_ui8matrix_basic(X,i0  ,j0-1,j1+1,T);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_dilatation3_ui8matrix_basic(X,i+1,j0-1,j1+1,T);
        line_erosion3_ui8matrix_basic(T,i  ,j0  ,j1  ,Y);
    }

    //epilogue pipeline
    line_erosion3_ui8matrix_basic(T,i1  ,j0  ,j1  ,Y);
}
// ----------------------------------------------------------------------------------------------------
...
{
    //prologue pipeline
    line_dilatation3_ui8matrix_red(X,i0-1,j0-1,j1+1,T);
    line_dilatation3_ui8matrix_red(X,i0  ,j0-1,j1+1,T);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_dilatation3_ui8matrix_red(X,i+1,j0-1,j1+1,T);
        line_erosion3_ui8matrix_red(T,i  ,j0  ,j1  ,Y);
    }

    //epilogue pipeline
    line_erosion3_ui8matrix_red(T,i1  ,j0  ,j1  ,Y);
}
// ---------------------------------------------------------------------------------------------------------
...
{
    //prologue pipeline
    line_dilatation3_ui8matrix_ilu3_red(X,i0-1,j0-1,j1+1,T);
    line_dilatation3_ui8matrix_ilu3_red(X,i0  ,j0-1,j1+1,T);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_dilatation3_ui8matrix_ilu3_red(X,i+1,j0-1,j1+1,T);
        line_erosion3_ui8matrix_ilu3_red(T,i  ,j0  ,j1  ,Y);
    }

    //epilogue pipeline
    line_erosion3_ui8matrix_ilu3_red(T,i1  ,j0  ,j1  ,Y);
}
// ---------------------------------------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------------------------------------
{
    ...
    line_dilatation3_ui8matrix_elu2_red(X,i0-1,j0-1,j1+1,T);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_dilatation3_ui8matrix_elu2_red(X,i+1,j0-1,j1+1,T);

        line_erosion3_ui8matrix_elu2_red(T,i  ,j0  ,j1  ,Y);
...
{
    //prologue pipeline
    line_dilatation3_ui8matrix_elu2_red_factor(X,i0-1,j0-1,j1+1,T);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_dilatation3_ui8matrix_elu2_red_factor(X,i+1,j0-1,j1+1,T);
        line_erosion3_ui8matrix_elu2_red_factor(T,i  ,j0  ,j1  ,Y);
    }
...
{
    //prologue pipeline
    line_dilatation3_ui8matrix_ilu3_elu2_red(X,i0-1,j0-1,j1+1,T);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_dilatation3_ui8matrix_ilu3_elu2_red(X,i+1,j0-1,j1+1,T);
        line_erosion3_ui8matrix_ilu3_elu2_red(T,i  ,j0  ,j1  ,Y);
    }
...
// ---------------------------------------------------------------------------------------------------------------------
{
    ...
    line_dilatation3_ui8matrix_ilu3_elu2_red_factor(X,i0-1,j0-1,j1+1,T);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_dilatation3_ui8matrix_ilu3_elu2_red_factor(X,i+1,j0-1,j1+1,T);

        line_erosion3_ui8matrix_ilu3_elu2_red_factor(T,i  ,j0  ,j1  ,Y);
