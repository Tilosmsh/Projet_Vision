...
// -----------------------------------------------------------------------------------------------
{
    ...
    for(int j = j0 ; j <= j1 ; j++ ){
        ...
        z[0][0]=i64erosion_mat33(x,1,1);
        z[0][1]=i64erosion_mat33(x,1,2);
        z[0][2]=i64erosion_mat33(x,1,3);

        z[1][0]=i64erosion_mat33(x,2,1);
        z[1][1]=i64erosion_mat33(x,2,2);
        z[1][2]=i64erosion_mat33(x,2,3);

        z[2][0]=i64erosion_mat33(x,3,1);
        z[2][1]=i64erosion_mat33(x,3,2);
        z[2][2]=i64erosion_mat33(x,3,3);

        max=i64dilatation_mat33(z,1,1);
        store2(Y,i,j,max);
    }
}
// --------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------------
{
    ...
    for(int j = j0 ; j <= j1 ; j++ ){
        ...
        z[0][0]=i64erosion_mat33(x,2,1);
        z[0][1]=i64erosion_mat33(x,2,2);
        z[0][2]=i64erosion_mat33(x,2,3);

        z[1][0]=i64erosion_mat33(x,3,1);
        z[1][1]=i64erosion_mat33(x,3,2);
        z[1][2]=i64erosion_mat33(x,3,3);

        z[2][0]=i64erosion_mat33(x,4,1);
        z[2][1]=i64erosion_mat33(x,4,2);
        z[2][2]=i64erosion_mat33(x,4,3);
...
{
    //prologue pipeline
    line_erosion3_ui64matrix_swp64_basic(X,i0-1,j0-1,j1+1,Y);
    line_erosion3_ui64matrix_swp64_basic(X,i0  ,j0-1,j1+1,Y);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_erosion3_ui64matrix_swp64_basic(X,i+1,j0-1,j1+1,Y);
        line_dilatation3_ui64matrix_swp64_basic(Y,i  ,j0  ,j1  ,Z);
    }

    //epilogue pipeline
    line_dilatation3_ui64matrix_swp64_basic(Y,i1  ,j0  ,j1  ,Z);
}
// --------------------------------------------------------------------------------------------------------------
...
{
    //prologue pipeline
    line_erosion3_ui64matrix_swp64_red(X,i0-1,j0-1,j1+1,Y);
    line_erosion3_ui64matrix_swp64_red(X,i0  ,j0-1,j1+1,Y);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_erosion3_ui64matrix_swp64_red(X,i+1,j0-1,j1+1,Y);
        line_dilatation3_ui64matrix_swp64_red(Y,i  ,j0  ,j1  ,Z);
    }

    //epilogue pipeline
    line_dilatation3_ui64matrix_swp64_red(Y,i1  ,j0  ,j1  ,Z);
}
// -------------------------------------------------------------------------------------------------------------------
...
{
    //prologue pipeline
    line_erosion3_ui64matrix_swp64_ilu3_red(X,i0-1,j0-1,j1+1,Y);
    line_erosion3_ui64matrix_swp64_ilu3_red(X,i0  ,j0-1,j1+1,Y);

    //pipeline
    for(int i = i0; i <= i1-1; i++){
        line_erosion3_ui64matrix_swp64_ilu3_red(X,i+1,j0-1,j1+1,Y);
        line_dilatation3_ui64matrix_swp64_ilu3_red(Y,i  ,j0  ,j1  ,Z);
    }

    //epilogue pipeline
    line_dilatation3_ui64matrix_swp64_ilu3_red(Y,i1  ,j0  ,j1  ,Z);
}
// -------------------------------------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------------------------------------
{
    ...
    line_erosion3_ui64matrix_swp64_elu2_red(X,i0-1,j0-1,j1+1,Y);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_erosion3_ui64matrix_swp64_elu2_red(X,i+1,j0-1,j1+1,Y);

        line_dilatation3_ui64matrix_swp64_elu2_red(Y,i  ,j0  ,j1  ,Z);
...
{
    //prologue pipeline
    line_erosion3_ui64matrix_swp64_elu2_red_factor(X,i0-1,j0-1,j1+1,Y);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_erosion3_ui64matrix_swp64_elu2_red_factor(X,i+1,j0-1,j1+1,Y);
        line_dilatation3_ui64matrix_swp64_elu2_red_factor(Y,i  ,j0  ,j1  ,Z);
    }
...
{
    //prologue pipeline
    line_erosion3_ui64matrix_swp64_ilu3_elu2_red(X,i0-1,j0-1,j1+1,Y);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_erosion3_ui64matrix_swp64_ilu3_elu2_red(X,i+1,j0-1,j1+1,Y);
        line_dilatation3_ui64matrix_swp64_ilu3_elu2_red(Y,i  ,j0  ,j1  ,Z);
    }
...
// -------------------------------------------------------------------------------------------------------------------------------
{
    line_erosion3_ui64matrix_swp64_ilu3_elu2_red_factor(X,i0-1,j0-1,j1+1,Y);

    //pipeline
    int r = (i1-i0+1)%2;
    for(int i = i0; i <= i1-r; i+=2){

        line_erosion3_ui64matrix_swp64_ilu3_elu2_red_factor(X,i+1,j0-1,j1+1,Y);

        line_dilatation3_ui64matrix_swp64_ilu3_elu2_red_factor(Y,i  ,j0  ,j1  ,Z);
