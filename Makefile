...
FILE_SWP      = swp.c 
FILE_TEST     = morpho_test.c motion_test.c
...
FILE = $(FILE_NRC) $(FILE_MORPHO) $(FILE_MORPHO64) $(FILE_MOTION) $(FILE_SWP)  $(FILE_UE_L3_VISION) $(FILE_TEST) $(FILE_MAIN) 
...
C_OPTIMISATION_FLAGS = -std=c99 -O3 -Wno-comment
#C_OPTIMISATION_FLAGS = -std=c99 -O0 -Wno-comment
